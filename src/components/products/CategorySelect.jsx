...
const CategorySelect = () => {
  ...
  return (
    <section>
      <form onSubmit={(e) => handleSubmit(e)} className="flex justify-center gap-10">
      <div className="form-control w-full max-w-xs">
        <label className="label">
          <span className="text-lg text-white">Elige una categoría:</span>
        </label>
        <select defaultValue="Categoría" onChange={(value) => handleCategory(value)} className="select select-bordered">
          <option disabled>Categoría</option>
          <option value="teclados">Teclados</option>
          <option value="mouses">Mouses</option>
          <option value="auriculares-y-microfonos">Auriculares y Micrófonos</option>
